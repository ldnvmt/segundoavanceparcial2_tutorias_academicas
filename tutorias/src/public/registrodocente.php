...
<body bgcolor="white">                     
    ...
    <div class="container">
        <nav class="menu">
            ...
            <ul class ="nav">
                ...
                <li> <a href="./contactodocente.php"> Contacto </a> </li>
                <li> <a href="./iniciodocente.html"> Iniciar Sesión </a> </li>
	...
	<?php
		if (isset ($_POST ['ENVIAR']))
		{
			...
			$r=mysqli_query($link, "Insert into registro_docente (nombre,apellido,numerotelefono,direccion,email,contrasena,cedula)values('$nombre2','$apellido2','$ntele2','$direccion2','$email2','$contrasena2','$cedula2')");
			if (!$r)
				printf ("Error %5\n",mysqli_error($link));
 ...
 <div class="container1">
        <main class="content">
            <form  action="registrodocente.php" method="POST" id="form">  
                <div class="form">                            
                    <h1>Registrarse como docente</h1>    <br>       
                    <div class="grupo">                
                    ...
                    <div class="grupo">                
                        ...
                        <input type="text" name="apellido" id="apellido" PlaceHolder='Ingrese un apellido' required><span class="barra"></span> 
                    </div>
                    <div class="grupo">                
                    ...
                    <div class="grupo">
                        ...
                        <input type="text" name="direccion" id="direccion" PlaceHolder='Ingrese su dirección de domicilio' required><span class="barra"></span>                   
                    </div>  
                    <div class="grupo">
                    ...
                    <div class="grupo">
                        ...
                        <input type="text" name="contrasena" id="contraseña" PlaceHolder='Ingrese una contraseña' required><span class="barra"></span>                   
                    </div>                   
                    <div class="grupo">                
                        <label for=""> Cedula de identidad</label>
                        <input type="text" name="cedula" id="cedula" PlaceHolder='Ingrese su cedula de identidad' required><span class="barra"></span> 
                     <br>
