...
<body bgcolor="white">                     
	...
	<?php
		if (isset ($_POST ['ENVIAR']))
		{
			...
			$mensaje=$_POST ["mensaje"];
							header("location: contactodocente.php");
			...
			$r=mysqli_query($link, "Insert into contacto_docente (nombre1, email1, telefono1, mensaje1)values('$nombre','$email','$ntele','$mensaje')");
			if (!$r)
				printf ("Error %5\n",mysqli_error($link));
 ...
 <div class="container1">
        <main class="content">
            <form  action="contactodocente.php" method="POST" id="form">  
                <div class="form">                            
                    <h1>Contacto</h1>    <br>       
                    <div class="grupo">                
